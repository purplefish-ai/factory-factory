...
**Goal:** Add user management and billing so the product can ship to real users.
...
Users can sign up, authenticate, choose a plan, pay, and use the product within their plan limits. All API endpoints are user-scoped. The Cloud MVP is shippable.
