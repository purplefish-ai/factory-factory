...
| `ratchetEnabled`, `ratchetState`, `ratchetLastCheckedAt`, `ratchetLastPushAt`, `ratchetActiveSessionId`, `ratchetLastCiRunId` | ratchet domain services (`src/backend/domains/ratchet/`) |
