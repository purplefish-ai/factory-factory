...
import { EpicState } from '../../lib/prisma-enums';
...
export default function EpicsPage() {
  ...
  const { data: epics, isLoading } = trpc.epic.list.useQuery(
    stateFilter ? { state: stateFilter as EpicState } : undefined,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage your development epics</p>
        </div>
        <Link
          href="/epics/new"
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        {!epics || epics.length === 0 ? (
          <div className="p-8 text-center text-gray-500">
            <p>No epics found.</p>
            <Link href="/epics/new" className="text-blue-600 hover:text-blue-800 mt-2 inline-block">
