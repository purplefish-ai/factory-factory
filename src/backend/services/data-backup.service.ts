...
const exportedWorkspaceSchema = z.object({
  ...
  creationSource: z.nativeEnum(WorkspaceCreationSource),
  creationMetadata: z.record(z.string(), z.unknown()).nullable(),
    ...
    await tx.workspace.create({
      data: {
        ...
        creationMetadata: w.creationMetadata
          ? (w.creationMetadata as Prisma.InputJsonValue)
          : undefined,
    ...
    const exportData: ExportData = {
      ...
      data: {
        ...
        workspaces: workspaces.map((w) => ({
          ...
          creationMetadata: w.creationMetadata as Record<string, unknown> | null,
          initErrorMessage: w.initErrorMessage,
          initOutput: w.initOutput,
