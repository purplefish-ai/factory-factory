...
<task type="auto">
  <name>Task 2: Build AcpClientHandler, AcpRuntimeManager, barrel file, and unit tests</name>
  <files>
    src/backend/domains/session/acp/acp-client-handler.ts
    src/backend/domains/session/acp/acp-runtime-manager.ts
    src/backend/domains/session/acp/index.ts
  ...
  <action>
**Step 1: Create `src/backend/domains/session/acp/acp-client-handler.ts`:**
...
**Step 2: Create `src/backend/domains/session/acp/acp-runtime-manager.ts`:**
...
**Step 3: Create `src/backend/domains/session/acp/index.ts`:**
...
**Step 4: Create `src/backend/domains/session/acp/acp-runtime-manager.test.ts`:**
