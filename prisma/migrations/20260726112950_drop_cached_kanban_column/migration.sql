/*
  ...
  - You are about to drop the column `cachedKanbanColumn` on the `Workspace` table. All the data in the column will be lost.
  - You are about to drop the column `stateComputedAt` on the `Workspace` table. All the data in the column will be lost.
