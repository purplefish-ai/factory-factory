/*
  ...
  - You are about to drop the column `ratchetLastNotifiedState` on the `Workspace` table. All the data in the column will be lost.
  - You are about to drop the column `ratchetLastPushAt` on the `Workspace` table. All the data in the column will be lost.
