...
CREATE TABLE "new_UserSettings" (
    ...
    "autoFixPrReviewComments" BOOLEAN NOT NULL DEFAULT false,
    "prReviewFixAllowedUsers" JSONB,
    "prReviewFixPrompt" TEXT,
...
INSERT INTO "new_UserSettings" ("autoFixCiIssues", "cachedSlashCommands", "createdAt", "customIdeCommand", "id", "notificationSoundPath", "playSoundOnComplete", "preferredIde", "updatedAt", "userId", "workspaceOrder") SELECT "autoFixCiIssues", "cachedSlashCommands", "createdAt", "customIdeCommand", "id", "notificationSoundPath", "playSoundOnComplete", "preferredIde", "updatedAt", "userId", "workspaceOrder" FROM "UserSettings";
