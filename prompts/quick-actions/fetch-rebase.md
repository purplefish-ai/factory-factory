...
Please fetch the latest changes from origin and rebase the current branch onto
origin/main. Follow these steps:
...
If there are any conflicts during the rebase, help me resolve them. Provide
clear feedback about what happened during each step.
